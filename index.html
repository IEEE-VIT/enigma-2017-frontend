  ...
  <div style="float:right; margin-right: 20px; margin-top: 25px; font-size: 20px;">
    ...
    <div class="popup">
          ...
          <div class="col-md-8 col-md-offset-2">
            <form name="register_form" id="registerForm" enctype="application/json" action="https://enigma2.herokuapp.com/auth/save" method="post">
              <div class="row">
                
                      
                  <div class="form-group">

                    <input type="text" id="Email-log" name="email" class="form-control" placeholder="Email" required="required">
                    <p class="help-block text-danger"></p>
                  </div>

                        <div class="form-group">
                    <input type="password" id="pass-log" name="password" class="form-control" placeholder="Password" required="required">
                    <p class="help-block text-danger"></p>
                  </div>
        ...
        <div class="col-md-8 col-md-offset-2">
          <form name="register_form" id="registerForm" method="post">
            <div class="row">
                ...
                <div class="form-group">
                  <input type="text" id="Phoneno" name="contact" class="form-control" placeholder="Phone no." required="required">
                  <p class="help-block text-danger"></p>
                </div>

                <div class="form-group">
                  <input type="password" id="pass" name="password" class="form-control" placeholder="Enter new Password" required="required">
                  <p class="help-block text-danger"></p>
                </div>
  ...
  <div id="" class="container" style="height: 620px;">
    ...
    <!-- ENIGMA Scroll -->
      ...
      <div class="col-md-8 col-md-offset-2">
        ...
        <p class="scrollto--arrow"><a href="#about" class="page-scroll"><img src="img/down.png" alt="scroll down arrow" id="enigma_arrow"></a></p>
      </div>
    </div>
  </div>
</div>
